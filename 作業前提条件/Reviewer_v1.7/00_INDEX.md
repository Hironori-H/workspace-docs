# インデックス - Reviewer用 v1.7

## 📌 このモジュールについて

**用途**: Reviewer作業の開始手順とモジュール選択ガイド
**必読条件**: レビュー作業開始時に必ず確認
**関連モジュール**: 00_QUICK_REFERENCE.md（最重要ルール）、01-04の各モジュール

## 📝 変更履歴

- **v1.7** (2025-11-24): 分割版同期 - ハルシネーション・暴走抑止定義を大幅強化
  - 統合版v1.7の内容を分割版に反映
  - 新規ファイル: `04_ハルシネーション抑止とベストプラクティス.md`
...
### 04_ハルシネーション抑止とベストプラクティス.md
**用途**: Reviewer特有のハルシネーション抑止と確認原則
**必読条件**: レビュー作業開始前、複雑な作業時
**内容**:
- レビュー時の確認原則（ファイル確認、コード内容確認、仕様との照合）
- 評価の根拠を明示
- 擬人化・感情表現の厳禁
- 指示なし実装・暴走の厳禁
- 目的の明示と定期確認
- 対話パターンの自己認識と抑止（7パターン定義）
- 作業前提条件の遵守確認
